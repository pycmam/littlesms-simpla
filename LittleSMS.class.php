...
class LittleSMS
{
     ...
     */
    function LittleSMS($user, $key, $useSSL = false, $testMode = false)
    {
        $this->user = $user;
        $this->key = $key;
        $this->useSSL = $useSSL;
     ...
     */
    function checkStatus($messagesId)
    {
     ...
     * @return stdClass
     */
    function makeRequest($function, array $params = array())
    {
     ...
     * @return string
     */
    function generateSign(array $params)
    {
