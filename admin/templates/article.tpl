  ...
  <table id="in_right">
    <tr>
      <td>
        <p>
          <a href="./">Simpla</a> →
          <a href='index.php?section=Articles'>Статьи</a>
           → {if $Item->article_id}{$Item->header}{else}Новая статья{/if}
        </p>
      </td>
    </tr>
  </table>
  ...
  <div id="cont_border">
    <div id="cont">
      ...
      <div id="cont_top">
	    ...
	    <!-- Заголовок раздела /-->
        <h1 id="headline">{if $Item->article_id}{$Item->header}{else}Новая статья{/if}</h1>
        <!-- /Заголовок раздела /-->
        
        <!-- Помощь /-->
        <div id="help">
          <a href="usermanual.html?height=450&width=700&scrollto=article" title="Помощь" class="thickbox">Помощь</a>
        </div>
        <!-- /Помощь /-->
      </div>
...
{include file='tinymce_init.tpl' on_init='autometageneration_init'}
...
var item_form = document.article;
