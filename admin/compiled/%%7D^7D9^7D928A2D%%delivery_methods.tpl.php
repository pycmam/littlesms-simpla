<?php /* Smarty version 2.6.25, created on 2010-11-21 21:30:54
         compiled from delivery_methods.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'delivery_methods.tpl', 83, false),)), $this); ?>
<div id="inserts_all">
  <!-- Вкладки /-->
  <ul id="inserts">
  ...
  <div id="cont_border">
    <div id="cont">
      ...
      <div id="cont_top">
		...
		<!-- Помощь2 /-->
        <div class="help2">
           <a href="index.php?section=DeliveryMethod&token=<?php echo $this->_tpl_vars['Token']; ?>
" class="fl"><img src="./images/add.jpg" alt="" class="fl"/>Добавить способ</a>              
        </div>
        <!-- /Помощь2 /-->
...
?>
              <tr>
                <td>
                  <div class="list_left">
                    <a href="index.php?section=DeliveryMethods&enable_id=<?php echo $this->_tpl_vars['item']->delivery_method_id; ?>
...
" class="<?php if ($this->_tpl_vars['item']->enabled): ?>tovar_on<?php else: ?>tovar_off<?php endif; ?>"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']->name)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                      ...
                      <p class=tovar_min>
                        Стоимость <?php echo ((is_array($_tmp=$this->_tpl_vars['item']->price)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 <?php echo $this->_tpl_vars['MainCurrency']->sign; ?>
. Бесплатно от <?php echo ((is_array($_tmp=$this->_tpl_vars['item']->free_from)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 <?php echo $this->_tpl_vars['MainCurrency']->sign; ?>

                      </p>
                    </div>
			      </div>
                  <a href="index.php?section=DeliveryMethods&act=delete&item_id=<?php echo $this->_tpl_vars['item']->delivery_method_id; ?>
&token=<?php echo $this->_tpl_vars['Token']; ?>
