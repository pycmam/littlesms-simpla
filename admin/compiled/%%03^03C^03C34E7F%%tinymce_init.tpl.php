...
<script language="javascript">
  ...
  tinyMCE.init(<?php echo '{'; ?>
	...
	plugin_smexplorer_directory : "<?php echo $this->_tpl_vars['root_dir']; ?>
/files/",	
	plugin_smimage_directory : "<?php echo $this->_tpl_vars['root_dir']; ?>
/files/images"
